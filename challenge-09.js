(function () {
    ...
    */
    const subtraction = calculator(20, 12);
    const multiplication = calculator(15, 6);
    const division = calculator(15, 3);
    const mod = calculator(14, 2);
