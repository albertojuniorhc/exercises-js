(function () {
    ...
    */
    ...
    const fullName = 'alberto-junior-martins-piccoli'

    const newFullName = fullName.split('-').map(function (name) {
    ...
    */
    console.log('\nMeus amigos:');
    const amigos = ['Nath', 'Tag', 'Glau', 'Biano']
    const phrase = amigos.reduce(function (acumulado, atual, index) {
