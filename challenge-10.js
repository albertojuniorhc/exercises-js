(function () {
    ...
    */
    ...
    function isOperatorValid(operator) {
        ...
        return !!operation[operator]; // !!operation[operator] (os !! retorna o valor booleano, e sempre que retornar uma function, é true, e undefined é false.)
    }
    ...
    */
    operationSignal = 'x';
    const calc = calculator(operationSignal);
    ...
    */
    // alterada variável sum para calc, e alterados valores do operationSignal
