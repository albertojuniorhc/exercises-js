(function () {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/g, 'Alberto Jr'));
    // ?
    ...
    */
    ...
    const regexDate = /(\d\d) de (janeiro|fevereiro|março|abril|maio|junho|julho|agosto|setembro|outubro|novembro|dezembro) de (\d\d\d\d)/g;
    ...
    */
    console.log('\nReplace de datas:');
    function replaceDate(capturaTotal, dayGrupoCaptura1, monthGrupoCaptura2, yearGrupoCaptura3) {
        return dayGrupoCaptura1 + '/' + getMonthNumber(monthGrupoCaptura2) + '/' + yearGrupoCaptura3;
    }
    console.log(text.replace(regexDate, replaceDate))
    //console.log(text.replace(texto que será procurado, função de callback já criada)) 
})();